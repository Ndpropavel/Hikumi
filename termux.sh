...
eval "cat ~/Hikumi/assets/download.txt"
printf "\n\n\033[1;35mHikumi is being installed... ✨\033[0m"
...
eval "rm -rf ~/Hikumi 2>/dev/null"
eval "cd && git clone https://github.com/hikariatama/Hikumi && cd Hikumi"
...
if [[ -z "${NO_AUTOSTART}" ]]; then
    ...
    echo 'clear && . <(wget -qO- https://github.com/hikariatama/Hikumi/raw/master/banner.sh) && cd ~/Hikumi && python3 -m hikumi' > ~/.bash_profile"

    printf "\r\033[K\033[0;32mAutostart enabled!\e[0m\n"
fi

echo -e "\033[0;96mStarting Hikumi...\033[0m"
echo -e "\033[2J\033[3;1f"

printf "\033[1;32mHikumi is starting...\033[0m\n"

eval "python3 -m hikumi"
