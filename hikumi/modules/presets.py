...
PRESETS = {
    "fun": [
        ...
        "https://heta.hikariatama.ru/vsecoder/hikumi_modules/mazemod.py",
    ],
    "chat": [
    ...
    "service": [
        ...
        "https://mods.hikariatama.ru/vtt.py",
        "https://heta.hikariatama.ru/vsecoder/hikumi_modules/accounttime.py",
        "https://heta.hikariatama.ru/vsecoder/hikumi_modules/searx.py",
        "https://heta.hikariatama.ru/iamnalinor/FTG-modules/swmute.py",
    ],
    "downloaders": [
        ...
        "https://heta.hikariatama.ru/CakesTwix/Hikumi-Modules/tikcock.py",
        "https://heta.hikariatama.ru/CakesTwix/Hikumi-Modules/InlineYouTube.py",
        "https://heta.hikariatama.ru/CakesTwix/Hikumi-Modules/InlineSpotifyDownloader.py",
...
class Presets(loader.Module):
    """Suggests new Hikumi users a packs of modules to load"""
