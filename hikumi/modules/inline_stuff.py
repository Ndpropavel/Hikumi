...
class InlineStuff(loader.Module):
    ...
    @loader.command()
    async def ch_hikumi_bot(self, message: Message):
        ...
        self._db.set("hikumi.inline", "custom_bot", args)
    ...
    async def aiogram_watcher(self, message: BotInlineMessage):
        ...
        await message.answer_photo(
            "https://github.com/hikariatama/assets/raw/master/hikumi_banner.png",
            caption=self.strings("this_is_hikumi"),
        )
