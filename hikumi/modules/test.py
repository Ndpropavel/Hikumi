...
class Tester(loader.Module):
        ...
        self.config = loader.ModuleConfig(
            loader.ConfigValue(
                ...
                (
                    ...
                    " Hikumi will try to determine, which client caused logs. E.g. there"
                    ...
                    " Hikumi will send all logs to Client1 and Client2, even if it is"
    ...
    async def pbe(self, message: Message):
        await utils.answer(
            ...
            " account, or Hikumi installation. This may cause irreversible damage to"
            " your server and account, or might just require Hikumi re-installation."
    ...
    async def logs(
        ...
        other = (
            *main.__version__,
            (
                " <a"
                f' href="https://github.com/hikariatama/Hikumi/commit/{ghash}">@{ghash[:8]}</a>'
                if ghash
                else ""
            ),
        )
    ...
    async def client_ready(self):
        chat, _ = await utils.asset_channel(
            self._client,
            "hikumi-logs",
            "🌘 Your Hikumi logs will appear in this chat",
            silent=True,
            invite_bot=True,
            avatar="https://github.com/hikariatama/assets/raw/master/hikumi-logs.png",
        )
