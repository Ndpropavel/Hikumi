...
from hikumitl.utils import resolve_inline_message_id
...
class NewUnitHeta(loader.Module):
    ...
    strings = {
        ...
        "_cls_doc": "Manages stuff with @hikumimods_bot",
        ...
        self.config = loader.ModuleConfig(
            loader.ConfigValue(
                ...
                (
                    ...
                    " the language, specified in Hikumi? (This option is experimental,"
