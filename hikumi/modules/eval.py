...
import hikumitl
from hikumitl.errors.rpcerrorlist import MessageIdInvalidError
from hikumitl.sessions import StringSession
from hikumitl.tl.types import Message
from meval import meval

from .. import loader, main, utils
from ..log import HikumiException
...
class Evaluator(loader.Module):
    ...
    async def e(self, message: Message):
        try:
            ...
            item = HikumiException.from_exc_info(*sys.exc_info())
    ...
    def censor(self, ret: str) -> str:
        ret = ret.replace(str(self._client.hikumi_me.phone), "&lt;phone&gt;")
        ...
        if btoken := self._db.get("hikumi.inline", "bot_token", False):
            ret = ret.replace(
                btoken,
                f'{btoken.split(":")[0]}:{"*" * 26}',
            )
    ...
    async def getattrs(self, message: Message) -> dict:
        ...
        return {
            ...
            "reply": reply,
            "r": reply,
            **self.get_sub(hikumitl.tl.types),
            **self.get_sub(hikumitl.tl.functions),
            "event": message,
            "chat": message.to_id,
            "hikumitl": hikumitl,
            "telethon": hikumitl,
            ...
            **dict(
                itertools.chain.from_iterable([
                    ...
                    for y in filter(
                        ...
                        and x[1] != obj
                        and x[1].__package__.rsplit(".", _depth)[0] == "hikumitl.tl",
                        obj.__dict__.items(),
                    )
                ])
            ),
