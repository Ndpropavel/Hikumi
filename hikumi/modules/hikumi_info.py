...
@loader.tds
class HikumiInfo(loader.Module):
    """Show userbot info"""

    strings = {"name": "HikumiInfo"}
    ...
    def __init__(self):
        self.config = loader.ModuleConfig(
            ...
            loader.ConfigValue(
                "custom_button",
                ["🌘 Support chat", "https://t.me/hikumi_talks"],
    ...
    def _render_info(self, inline: bool) -> str:
        ...
        me = '<b><a href="tg://user?id={}">{}</a></b>'.format(
            self._client.hikumi_me.id,
            utils.escape_html(get_display_name(self._client.hikumi_me)),
        )
        ...
        return (
            (
                "<b>🌘 Hikumi</b>\n"
                if "hikumi" not in self.config["custom_message"].lower()
                else ""
            )
                ...
                *map(
                    ...
                    (
                        (
                            ...
                            if self._client.hikumi_me.premium and not inline
                            else "🌘 Hikumi"
                        ),
    ...
    async def info(self, _: InlineQuery) -> dict:
        ...
        return {
            ...
            **(
            ...
            "thumb": (
                "https://github.com/hikariatama/Hikumi/raw/master/assets/hikumi_pfp.png"
            ),
    ...
    @loader.command()
    async def hikumiinfo(self, message: Message):
