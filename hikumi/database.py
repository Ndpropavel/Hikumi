...
from hikumitl.errors.rpcerrorlist import ChannelsTooMuchError
from hikumitl.tl.types import Message, User
    ...
    async def init(self):
        ...
        try:
            channel, _ = await utils.asset_channel(
                self._client,
                "hikumi-assets",
                "🌆 Your Hikumi assets will be stored here",
                archive=True,
                avatar="https://raw.githubusercontent.com/hikariatama/assets/master/hikumi-assets.png",
            )
