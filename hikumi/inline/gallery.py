...
from hikumitl.errors.rpcerrorlist import ChatSendInlineForbiddenError
from hikumitl.extensions.html import CUSTOM_EMOJIS
from hikumitl.tl.types import Message

from .. import main, utils
from ..types import HikumiReplyMarkup
...
class Gallery(InlineUnit):
    async def gallery(
        ...
        *,
        custom_buttons: typing.Optional[HikumiReplyMarkup] = None,
        force_me: bool = False,
        ...
        :param gif: Whether the gallery will be filled with gifs. If you omit this argument and specify
                    gifs in `next_handler`, Hikumi will try to determine the filetype of these images
        :param manual_security: By default, Hikumi will try to inherit inline buttons security from the caller (command)
                                If you want to avoid this, pass `manual_security=True`
        :param disable_security: By default, Hikumi will try to inherit inline buttons security from the caller (command)
        ...
        with contextlib.suppress(AttributeError):
            _hikumi_client_id_logging_tag = copy.copy(self._client.tg_id)  # noqa: F841
            ...
            try:
                status_message = await (
                    ...
                    (
                        ...
                        if self._client.hikumi_me.premium and CUSTOM_EMOJIS
                        else "🌘"
                    )
