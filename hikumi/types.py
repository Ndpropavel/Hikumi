...
from hikumitl.tl.functions.account import UpdateNotifySettingsRequest
...
from hikumitl.utils import get_input_peer
...
HikumiReplyMarkup = typing.Union[typing.List[typing.List[dict]], typing.List[dict], dict]
...
class Module:
    ...
    @property
    def hikumi_commands(self) -> typing.Dict[str, Command]:
        """List of commands that module supports"""
        return get_commands(self)
    ...
    @property
    def hikumi_inline_handlers(self) -> typing.Dict[str, Command]:
        """List of inline handlers that module supports"""
        return get_inline_handlers(self)
    ...
    @property
    def hikumi_callback_handlers(self) -> typing.Dict[str, Command]:
        """List of callback handlers that module supports"""
        return get_callback_handlers(self)
    ...
    @property
    def hikumi_watchers(self) -> typing.Dict[str, Command]:
        """List of watchers that module supports"""
        return get_watchers(self)
    ...
    @hikumi_commands.setter
    def hikumi_commands(self, _):
        pass
    ...
    @hikumi_inline_handlers.setter
    def hikumi_inline_handlers(self, _):
        pass
    ...
    @hikumi_callback_handlers.setter
    def hikumi_callback_handlers(self, _):
        pass
    ...
    @hikumi_watchers.setter
    def hikumi_watchers(self, _):
        pass
    ...
    async def animate(
        ...
        *,
        ...
        with contextlib.suppress(AttributeError):
            _hikumi_client_id_logging_tag = copy.copy(self.client.tg_id)  # noqa: F841
    ...
    async def _decline(
        ...
        declined_joins = self._db.get("hikumi.main", "declined_joins", [])
    ...
    async def request_join(
        ...
        self.hikumi_wait_channel_approve = (
            self.__class__.__name__,
            channel,
            reason,
        )
        ...
        with contextlib.suppress(AttributeError):
            delattr(self, "hikumi_wait_channel_approve")
    ...
    async def import_lib(
        ...
        *,
        ...
        if re.search(r"# ?scope: ?hikumi_min", code):
            match = re.search(r"# ?scope: ?hikumi_min ((\d+\.){2}\d+)", code)
            if not match:
                _raise(ValueError("Invalid hikumi_min scope format"))
                raise
            ...
            if version.__version__ < ver:
                _raise(
                    RuntimeError(
                        f"Library requires Hikumi version {'{}.{}.{}'.format(*ver)}+"
                    )
                )

        module = f"hikumi.libraries.{url.replace('%', '%%').replace('.', '%d')}"
        ...
        if (
            ...
            and self._db.get("hikumi.main", "stats", True)
            and url is not None
